                ...
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="row g-lg-5 align-items-center justify-content-center">
                            <div class="col-md-6">
                                <h3 class="mb-4" style="text-align: center; ">En el mar zafiro</h3>
                                <img src="../../assets/images/Cuentos/mar.svg" class="cuento-img" alt="">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="d-flex flex-row">
                                        <div class="card m-3" style="width: 18rem; border: 3px solid #09BBBD;">
                                                <div class="card-body">
                                                    <a href="">
