    ...
    <section>
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="row mb-4 mb-md-5">
                    <div class="col-md-10 mx-auto">
                        <h3 class="mb-4" style="text-align: center;">¿Qué hacemos?</h3>
            ...
            <div class="row g-4 align-items-center">
                <!-- Image -->
                <div class="col-md-6">
                    <img src="../../assets/images/conocenos/1.png" class="rounded-3" alt="">
                </div>
                ...
                <div class="col-md-6">
                    <div class="row g-4">
                        <!-- Image -->
                        <div class="col-md-8">
                            <img src="../../assets/images/conocenos/2.png" class="rounded-3" alt="">
                        </div>
    
                        <!-- Image -->
                        <div class="col-12">
                            <img src="../assets/images/conocenos/3.png" class="rounded-3" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="row mb-4 mb-md-5">
                    <div class="col-md-10 mx-auto">
                        <h3 class="mb-4" style="text-align: center;">¿Cómo lo hacemos?</h3>
